var mainModule = (function(UIModule, dataModule) {
    ...
    function addExam() {
        ...
        if (exam.hasPassed()) {
            UIModule.updateLists(UIModule.UISelectors.passedStudentsList, exam.student.getStudentData(), exam.subject);
            increase = UIModule.UISelectors.passedNumber;
        } else {
            UIModule.updateLists(UIModule.UISelectors.failedStudentsList, exam.student.getStudentData(), exam.subject);
